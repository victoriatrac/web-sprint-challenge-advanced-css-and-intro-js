...
Accessibility on the web means that anyone, despite their disabilities or what device they're using, can process the information on a webpage.

2. Talk about 3 different things you can do to ensure your website is accessible. 

- Use responsive units for things like image sizing, font sizing, and container widths.

3. How would you explain the concept of a variable to someone new to programming?

A variable is a piece of data that you can create, assign information to, and access throughout the code.

4. What is the purpose of using functions in code?

Functions create processes that speed up an action that needs to be done repeatedly, so we're not typing the same lines of code to do the same task with different inputs.
